    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <?php if (isset($product_page)) { ?><a class="btn btn-info" href="<?php echo $product_page; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_view; ?>"><i class="fa fa-eye"></i></a>
                <?php } ?>
                        ...
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                                    ...
                                    <!-- Custom Field Table Ingredients -->
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="input-table<?php echo $language['language_id']; ?>">
                                                <?php echo $entry_tableingr; ?>
                                            </label>
                                            <div class="col-md-4">
                                                <div class="table-cont">
                                                    <input type="text" name="weight_table" value="<?php echo $weight_table; ?>" placeholder="Вес" id="input-weight_table" class="form-control" />
                                                    <input type="text" name="serving_size" value="<?php echo $serving_size; ?>" placeholder="Размер порции" id="input-serving_size" class="form-control" />
                                                    <input type="text" name="serving_number" value="<?php echo $serving_number; ?>" placeholder="Количество порций" id="input-serving_number" class="form-control" />
                                                    <input type="text" name="serving_row" value="<?php echo $serving_row; ?>" placeholder="Содержание в количестве порций" id="input-serving_row" class="form-control" />
                                                    <textarea type="text" name="name_count_components" placeholder="Описание для Заголовока1" id="input-description_table" class="form-control custom-area-desc" /><?php echo $name_count_components; ?></textarea>
                                                    <div class="text-info custom-info-text">Введите текст. Например: "Белки;10г/Углеводы;20г"</div>
                                                    <input type="text" name="second_title" value="<?php echo $second_title; ?>" placeholder="Заголовок1 текста под таблицей" id="input-second_title" class="form-control" />
                                                    <textarea type="text" name="description_table" placeholder="Описание для Заголовока1" id="input-description_table" class="form-control custom-area-desc" /><?php echo $description_table; ?></textarea>
                                                    <input type="text" name="third_title" value="<?php echo $third_title; ?>" placeholder="Заголовок2 текста под таблицей" id="input-third_title" class="form-control" />
                                                    <textarea type="text" name="application_method" placeholder="Описание для Заголовока2" id="input-application_method" class="form-control custom-area-desc" /><?php echo $application_method; ?></textarea>
                                                </div>
                                              </div>
                                              <div class="col-md-1">
                                              ...
                                              <div class="col-md-4">
                                                    <div class="table-container">
                                                        ...
                                                        <div class="two-row">
                                                        		<?php if (!empty($serving_number)){
                                                            echo $serving_number;
                                                            }else{
                                                            echo "Количество порций";
                                                          } ?>
                                                        </div>
                                                        <div class="four-row">
                                                        	<?php if (!empty($serving_row)){
                                                            echo $serving_row;
                                                            }else{
                                                            echo "Содержание в количестве порций";
                                                          } ?>
                                                        </div>
                                                        <?php if (empty($name_count_components)){ ?>
                                                        <div class="field-one">
                                                            <div class="name">
                                                            	<?php if (!empty($first_name_component)){
                                                            echo str_replace(' ', '&nbsp;', $first_name_component);
                                                            }else{
                                                            echo "Имя компонента";
                                                            ...
                                                            <div class="count">
                                                            	<?php if (!empty($first_count_component)){
                                                            echo $first_count_component;
                                                            }else{
                                                            echo "Содержание компонента";
                                                          } 
                                                          ?>
                                                            </div>
                                                        </div>
                                                        <?php } ?>
                                                        <?php 
                                                            $m_components = explode("/", $name_count_components);
                                                            for($j=0;$j<count($m_components);$j++){ 
                                                        ?>
	                                                    <div class="field-one">
	                                                        <div class="name">
	                                                                <?php echo stristr($m_components[$j], ';', true); ?>
	                                                            </div>
	                                                            <div class="count">
	                                                                <?php $count = stristr($m_components[$j], ';'); 
                                                                    echo substr($count,1);
                                                                    ?>
	                                                            </div>
	                                                        </div>
                                                        ...
                                                        <div class="text-ingr">
                                                        	<?php if (!empty($description_table)){
                                                            echo $description_table;
                                                            }else{
                                                            echo "Описание1 для Заголовока1";
                                                          } ?>
                                                        </div>
                                                        <div class="ingr">
                                                        	<?php if (!empty($third_title)){
                                                            echo $third_title;
                                                            }else{
                                                            echo "Заголовок2";
                                                          } ?>
                                                        ...
                                                        <div class="text-ingr">
                                                            ...
                                                            echo $application_method;
                                                            }else{
                                                            echo "Описание1 для Заголовока2";
                                                          } ?>
                                                        </div>
                                                    </div>
                                              </div>
                                            ...
                                            <!-- /-/-/ Custom Field Table Ingredients -->
                                            <div class="form-group custom-under-table-border">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="input-meta-h1<?php echo $language['language_id']; ?>">
                                                    <?php echo $entry_meta_h1; ?>
                                                </label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control">
                                                        <?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?>
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="stock_status_id" id="input-stock-status" class="form-control">
                                            ...
                                            <option value="<?php echo $stock_status['stock_status_id']; ?>" selected="selected">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="length_class_id" id="input-length-class" class="form-control">
                                            ...
                                            <option value="<?php echo $length_class['length_class_id']; ?>" selected="selected">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="weight_class_id" id="input-weight-class" class="form-control">
                                            ...
                                            <option value="<?php echo $weight_class['weight_class_id']; ?>" selected="selected">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="input-manufacturer" name="manufacturer_id" class="form-control">
                                            ...
                                            <option value="<?php echo $manufacturer['manufacturer_id']; ?>" selected="selected">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div id="product-download" class="well well-sm" style="height: 150px; overflow: auto;">
                                            ...
                                            <div id="product-download<?php echo $product_download['download_id']; ?>"><i class="fa fa-minus-circle"></i>
                                            ...
                                            <tr id="attribute-row<?php echo $attribute_row; ?>">
                                                ...
                                                <td class="text-left">
                                                    ...
                                                    <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                                                        <textarea name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-required<?php echo $option_row; ?>">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>">
                                                        <?php echo $entry_option_value; ?>
                                                    </label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea name="product_option[<?php echo $option_row; ?>][value]" rows="5" placeholder="<?php echo $entry_option_value; ?>" id="input-value<?php echo $option_row; ?>" class="form-control">
                                                            <?php echo $product_option['value']; ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            ...
                                            <tr id="recurring-row<?php echo $recurring_row; ?>">
                                                <td class="text-left">
                                                    <select name="product_recurring[<?php echo $recurring_row; ?>][recurring_id]" class="form-control">
                                                        ...
                                                        <option value="<?php echo $recurring['recurring_id']; ?>" selected="selected">
                                    ...
                                    <table id="discount" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="discount-row<?php echo $discount_row; ?>">
                                                ...
                                                <td class="text-right">
                                                    <input type="text" name="product_discount[<?php echo $discount_row; ?>][quantity]" value="<?php echo $product_discount['quantity']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" />
                                                </td>
                                                <td class="text-right">
                                                    <input type="text" name="product_discount[<?php echo $discount_row; ?>][priority]" value="<?php echo $product_discount['priority']; ?>" placeholder="<?php echo $entry_priority; ?>" class="form-control" />
                                                </td>
                                                <td class="text-right">
                                                    <input type="text" name="product_discount[<?php echo $discount_row; ?>][price]" value="<?php echo $product_discount['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" />
                                                </td>
                                    ...
                                    <table id="special" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="special-row<?php echo $special_row; ?>">
                                                ...
                                                <td class="text-right">
                                                    <input type="text" name="product_special[<?php echo $special_row; ?>][priority]" value="<?php echo $product_special['priority']; ?>" placeholder="<?php echo $entry_priority; ?>" class="form-control" />
                                                </td>
                                                <td class="text-right">
